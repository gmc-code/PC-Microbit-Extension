...
.. code-block:: python
    ...
    leds = maqueen.MaqueenNeoPixels(front=(20, 20, 20), indicator=(35, 25, 0), rear=(20, 0, 0))
    leds.set_front(rgb=(20, 20, 20))
    leds.set_indicator(rgb=(35, 25, 0))
    leds.set_rear(rgb=(20, 0, 0))
    leds.set_led(led_number, rgb=(20, 20, 20))
    leds.set_leds(rgb=(20, 20, 20))
    leds.all_lights()
    leds.front_lights()
    leds.rear_lights()
    leds.left_indicator()    
